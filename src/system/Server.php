...
class Server {
	 ...
	 * @return double
	 */
	public static function getSystemLoad(int $coreCount = 2, float $interval = 1) : float {
		
		if (self::_hasAdapter(self::class, __FUNCTION__))
			return self::_callAdapter(self::class, __FUNCTION__, $coreCount, $interval);
		...
		$calculated_load = self::_applyFilter(self::class, __FUNCTION__, $calculated_load, array('event' => 'return'));
	...
	public static function getSystemCores() : ?int {
		...
		$cores = self::_applyFilter(self::class, __FUNCTION__, $cores, array('event' => 'return'));
	...
	public static function getHttpConnections() {
		...
		if (function_exists('exec')) {
			...
			$connections = self::_applyFilter(self::class, __FUNCTION__, $connections, array('event' => 'return'));
	...
	public static function getServerMemoryUsage() {
		...
		$memory_usage = self::_applyFilter(self::class, __FUNCTION__, $memory_usage, array('event' => 'return'));
	...
	public static function getDiskUsage() {
		...
		$diskuse = self::_applyFilter(self::class, __FUNCTION__, $diskuse, array('event' => 'return'));
	...
	public static function getServerUptime() {
		...
		$uptime = self::_applyFilter(self::class, __FUNCTION__, $uptime, array('event' => 'return'));
	...
	public static function getKernelVersion() {
		...
		$kernel = self::_applyFilter(self::class, __FUNCTION__, $kernel, array('event' => 'return'));
	...
	public static function getNumberProcesses() {
		...
		$proc_count = self::_applyFilter(self::class, __FUNCTION__, $proc_count, array('event' => 'return'));
	...
	public static function getMemoryUsage() {
		...
		$memory = self::_applyFilter(self::class, __FUNCTION__, $memory, array('event' => 'return'));

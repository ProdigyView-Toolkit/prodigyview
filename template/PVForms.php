 ...
 *
 * echo PVForms::creatInput('name', 'text', array('class' => 'form-control', 'value' => 'My Name',
...
class PVForms extends PVStaticObject {
	 ...
	 * around the element.
	 * 				Options will be passed to PVHTML::getStandardAttributes() and PVHTML::getEventAttributes().
	 * Have the option
